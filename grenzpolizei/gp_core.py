...
class GrenzpolizeiCore:
    def __init__(self, bot):
        ...
        self.settings_file = (str(core_data_path()) + "\\cogs\\CogManager\\cogs\\grenzpolizei\\data\\settings.json").replace('\\', '/')
        self.ignore_file = (str(core_data_path()) + "\\cogs\\CogManager\\cogs\\grenzpolizei\\data\\ignore.json").replace('\\', '/')
